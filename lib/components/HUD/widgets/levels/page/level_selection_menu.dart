            ...
            child: BackdropFilter(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final double calculatedCardsPerRow =
                  (availableWidth / (LevelSelectionMenuVM.cardSpacing + 90)).floorToDouble();
                  final double cardsPerRow = calculatedCardsPerRow.clamp(3, double.infinity);
                  final double cardSize = (availableWidth -
                      (LevelSelectionMenuVM.cardSpacing * (cardsPerRow - 1))) /
                      cardsPerRow;
                            ...
                            children: [
                              Expanded(
                                child: SingleChildScrollView(
                                  ...
                                  child: Wrap(
                                    spacing: LevelSelectionMenuVM.cardSpacing,
                                    runSpacing: LevelSelectionMenuVM.cardSpacing,
                              ...
                              Column(
                                ...
                                children: [
                                  _buildScrollButton(
                                    ...
                                    onPressed: () => model.scrollByRow(forward: false, rowSize: cardSize),
                                    color: cardColor,
                                    iconColor: textColor,
                                  ...
                                  _buildScrollButton(
                                    ...
                                    onPressed: () => model.scrollByRow(forward: true, rowSize: cardSize),
                                    color: cardColor,
                                    iconColor: textColor,
                                    borderColor: borderColor,
                                  ),
